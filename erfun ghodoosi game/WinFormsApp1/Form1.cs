...
namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        //عدد ها
        int[] numbers= {2,4,8,16,32,64,128,256,512,1024};
       ...
       public int record = 0;
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            int number = numbers[mainNumberRandom.Next(1, 5)];
            nextNumber.Text = number.ToString();
            Random r = new Random();
            nextNumber.BackColor = Color.FromArgb(r.Next(200, 256), r.Next(200, 256), 0);
        }
        ...
        private void mainNumber_Click(object sender, EventArgs e)
        {
            ...
            mainNumber.Text = nextNumber.Text;
            mainNumber.BackColor = nextNumber.BackColor;
        ...
        void removeLabel(int[] labelArray,List<Label>labelList) 
        {
            ...
            if(labelArray[1] !=0)
            {
                ...
                int found = Array.IndexOf(numbers, sum);
                if (found != -1)
                {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (timer==0)
            {
                ...
                if (d == DialogResult.Yes)
                {
                    ...
                    //ثبت رکورد در متغیر(در لیبل موقع اینیشیالایز کردن کامپوننت ها نمایش داده میشود
                    if (score > record)
                    {
                        record = score;
                    }
